...
public class CarStationComparator implements Comparator<CarStation> {

	final double dx;
	final double dy;
	private ItineraryBuildHelper helper;

	public CarStationComparator(ItineraryBuildHelper helper, final double dx, final double dy) {
		this.helper = helper;
		this.dx = dx;
		this.dy = dy;
	}
	...
	@Override
	public int compare(CarStation o1, CarStation o2) {
