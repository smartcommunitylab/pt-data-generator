...
public class CacheGenerator extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		super.setUp();
		handler = new OTPHandler(router, "http://otp:7575");
...
//		cb.updateCache(router, "9", true, false);
//		cb.updateCache(router, "11", true, false);
//		cb.updateCache(router, "13", true, false);
//		cb.updateCache(router, "14", true, false);
//		ar.generateCache(router, "17", true);
...
//			}
//		};
//		RoutesDBHelper helper = new RoutesDBHelper(router, "trentino", false);
//		//helper.update("5", "6", "10", "16", "17");
//		helper.update(router, agencyIds);
//		helper.optimize();
//		helper.zip(router);
//		helper = new RoutesDBHelper(router, "trentino", true);
//		//helper.update("5", "6", "10", "16", "17");
//		helper.update(router, agencyIds);
//		helper.optimize();
//		helper.zip(router);
...
//		}};
//		
//		RoutesDBHelper helper = new RoutesDBHelper(router, "alpecimbra", false);
//		helper.update(router, agencyList);
//		helper.optimize();
//		helper.zip(router);
